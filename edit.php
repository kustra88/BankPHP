...
<html lang="pl">
 	...
 	<head>
 		<?php include 'include/head.php'; ?>
  		<title>EDYCJA DANYCH | Projekt programistyczny - bank PHP</title>
  	</head>
			            ...
			            <div class="col-md-9 wow slideInRight" data-wow-duration="0.2s" data-wow-delay="0.4s">
			             	<div class="padding10">
				                ...
				                <div class="input-group" style="margin-top: 80px;">
				                  	...
				                  	<input type="text" class="form-control" placeholder="Jan" aria-describedby="sizing-addon2">
				                </div><br>
				                <div class="input-group">
				                  	<span class="input-group-addon" id="sizing-addon2"></span>
				                  	<input type="text" class="form-control" placeholder="Kowalski" aria-describedby="sizing-addon2">
				                </div><br>
				                <div class="input-group">
				                  	<span class="input-group-addon" id="sizing-addon2"></span>
				                  	<input type="text" class="form-control" placeholder="93072915678" aria-describedby="sizing-addon2">
				                </div><br>
				                <div class="input-group">
				                  	<span class="input-group-addon" id="sizing-addon2"></span>
				                  	<input type="text" class="form-control" placeholder="29-07-1993" aria-describedby="sizing-addon2">
				                </div><br>
				                <button type="button" class="btn btn-success squareBtn tl">
				                  	<span class="glyphicon glyphicon-ok"></span> AKTUALIZUJ DANE
				                </button>
